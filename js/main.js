/* ============================================
   BOXMAR GLOBAL LOGISTICS - Main JavaScript
   ============================================ */
...
const translations = {
  en: {
    ...
    'quote.name': 'Full Name', 'quote.email': 'Email Address', 'quote.phone': 'Phone Number',
    'quote.company': 'Company Name', 'quote.next': 'Next Step', 'quote.prev': 'Previous',
    ...
    'mv.mission': 'Mission Statement', 'mv.mission.text': 'Boxmar Global Logistics is a full service freight forwarder and customs broker committed to providing the highest levels of service and quality assurance.',
    'mv.vision': 'Vision Statement', 'mv.vision.text': 'To be the best customer service team in our profession. To develop and maintain a first-class infrastructure to ensure employee satisfaction, which drives customer loyalty, leading to sustained profit growth and improved company value.',
    'float.inquiry': 'INQUIRY', 'float.chat': 'Chat', 'quote.select': 'Select...',
  ...
  tr: {
    ...
    'quote.name': 'Ad Soyad', 'quote.email': 'E-posta Adresi', 'quote.phone': 'Telefon Numarası',
    'quote.company': 'Şirket Adı', 'quote.next': 'Sonraki Adım', 'quote.prev': 'Önceki',
    ...
    'mv.mission': 'Misyonumuz', 'mv.mission.text': 'Boxmar Global Lojistik, en yüksek düzeyde hizmet ve kalite güvencesi sağlamayı taahhüt eden tam kapsamlı bir freight forwarder ve gümrük komisyoncusudur.',
    'mv.vision': 'Vizyonumuz', 'mv.vision.text': 'Mesleğimizdeki en iyi müşteri hizmetleri ekibi olmak. Müşteri sadakatini artıran, sürekli kar büyümesine ve gelişmiş şirket değerine yol açan çalışan memnuniyetini sağlamak için birinci sınıf bir altyapı geliştirmek ve sürdürmek.',
    'float.inquiry': 'TALEP', 'float.chat': 'Sohbet', 'quote.select': 'Seçiniz...',
...
function applyTranslations(lang) {
  ...
  document.querySelectorAll('[data-i18n]').forEach(el => {
    ...
    if (t[key]) {
      ...
      } else if (t[key].includes('<br>') || t[key].includes('<')) {
        el.innerHTML = t[key];
      } else {
